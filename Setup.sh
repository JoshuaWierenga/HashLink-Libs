...
# TODO: Build hashlink instead of downloading?

haxe_version=4.3.6
#neko_version=2.4.0
#hashlink_version=latest
...
if [ ! -d hashlink ]; then
  download_file HashLink https://github.com/HaxeFoundation/hashlink/releases/download/latest/hashlink-f5e5223-linux-amd64.tar.gz hashlink.tar.gz
  extract_tar_gz HashLink hashlink.tar.gz hashlink
  rm hashlink.tar.gz
  printf "\n"
fi
